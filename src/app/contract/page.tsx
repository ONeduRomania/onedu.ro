...
export default function SponsorshipForm() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white text-gray-900">
            ...
            {/*                        Dacă ai mai realizat un contract de sponsorizare pentru <span className="font-bold">Asociația ONedu</span>, datele companiei tale vor fi precompletate. Te rugăm doar să le actualizezi, dacă este nevoie.*/}
            {/*                    </p>*/}

...
interface HeroParteneriProps {
    title: string;
    subtitle?: string;
}

export function HeroParteneri({ title, subtitle }: HeroParteneriProps) {
    return (
        <section
            ...
            <div className="relative z-10 flex flex-col items-center justify-center max-w-screen-xl w-full px-4 sm:px-6 lg:px-8 py-6 md:py-8">
                <div className="flex items-center justify-center gap-4 mb-2">
                    <div className="bg-white/20 backdrop-blur-sm p-3 rounded-full shadow-lg">
                        <FaHandshake className="text-2xl md:text-3xl text-white drop-shadow-lg" />
                    </div>

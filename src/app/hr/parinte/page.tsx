    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6">
            <header className="w-full flex flex-col items-center mb-10">
                ...
                />
                <h1 className="text-3xl font-bold text-gray-900 mt-4">Informații pentru Părinți</h1>
            </header>
            ...
            <div className="max-w-4xl w-full bg-white p-6 rounded-lg shadow-md space-y-6">
                <section>
                    ...
                    <a href={`${process.env.BASE_IMAGE_URL}docs/regulamente/ri-cor.pdf`} className="text-custom-blue font-semibold">Regulamentul intern</a>
                    <br/>
                    <a href={`${process.env.BASE_IMAGE_URL}docs/regulamente/politica-voluntariat.pdf`} className="text-custom-blue font-semibold">Politica de
                        voluntariat</a>
                    <br/>
                    <a href={`${process.env.BASE_IMAGE_URL}docs/regulamente/cod-etica.pdf`} className="text-custom-blue font-semibold">Codul de etică și
                ...
                <section>
                    ...
                    <p className="text-gray-600 mt-2">Consultați și descărcați template-urile contractelor pentru
                        voluntariat.</p>
                    <a href={`${process.env.BASE_IMAGE_URL}docs/hr/ctr-voluntariat.pdf`} className="text-custom-blue font-semibold">Descarcă
                        contractul</a>
                </section>
                ...
                <section>
                    ...
                    <a href={`${process.env.BASE_IMAGE_URL}docs/regulamente/norme-ssm.pdf`} className="text-custom-blue font-semibold">Descarcă normele SSM</a>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-800 font-semibold">Telefon: <a href="tel:+40759010153" className="text-custom-blue">0759 010 153</a></p>
                </section>
            </div>
        </div>
    );
